...
@interface RCT_EXTERN_MODULE(RCtBridgeSum, NSObject);
...
RCT_EXTERN_METHOD(showValue : (RCTResponseSenderBlock)callback);

RCT_EXTERN_METHOD(sumTwo: (NSInteger*)value value1: (NSInteger*)value1 _callback: (RCTResponseSenderBlock)_callback )
